...
include { SUBSAMPLE_FASTQ } from '../modules/transcriptomic_alignment/subsample_fastq.nf'
include { RUN_STAR } from '../modules/transcriptomic_alignment/run_star.nf'
include { STORE_ALIGNEMNT_RESULT } from '../modules/transcriptomic_alignment/store_alignment_result.nf'
